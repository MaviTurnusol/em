...
func apply_dialogue_line() -> void:
	...
	get_viewport().get_camera_2d().current_target = dialogue_marker.get_parent()
	...
	var panel: StyleBoxTexture = balloon.theme.get_stylebox("panel", "PanelContainer")
