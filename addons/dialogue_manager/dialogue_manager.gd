...
func show_dialogue_balloon(resource: DialogueResource, title: String = "", extra_game_states: Array = []) -> Node:
	...
	return show_dialogue_balloon_scene("res://Dialogue/dialogue_balloon.tscn", resource, title, extra_game_states)
...
func _get_fuckass_balloon_path() -> String:
	return "res://Dialogue/dialogue_balloon.tscn"
